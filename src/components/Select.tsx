...
export const Select = React.forwardRef<HTMLSelectElement, {label: string, options: string[]} & ReturnType<UseFormRegister<FieldValues>>>(({label, options, onChange, name, onBlur}, ref) => {
